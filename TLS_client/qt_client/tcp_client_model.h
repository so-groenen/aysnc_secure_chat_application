#ifndef TCP_CLIENT_MODEL_H
#define TCP_CLIENT_MODEL_H
...
class TcpClientModel : public QObject, public AbstractTcpClientModel
{
    Q_OBJECT
private:
...
public:
    explicit TcpClientModel(uint16_t port, QObject *parent = nullptr);
